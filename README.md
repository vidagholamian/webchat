...
برای این که دو کاربر از دو کامپیوتر مختلف بتوانند با هم چت کنند میتوانیم از فضاهای ابری مثل هیروکو استفاده کنیم.سرور را رو ی ان انتقال دهیم و کلاینت ها به سرور متصل شوند(کلاینت ها روی هر کامپیوتر)
کد این قسمت زده نشده 
